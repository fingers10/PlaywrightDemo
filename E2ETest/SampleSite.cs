...
public class SampleSite
{
    ...
    public async ValueTask<SampleSite> StartAsync()
    {
        ...
        var sampleSiteDir = Path.Combine(solutionDir, "Web");
        ...
        // Serve it.
        //var serverDllName = $"Web.{this.ProjectSubFolder}.dll";
        var serverDllName = $"Web.dll";
        ...
        else
        {
            ...
            this.dotnetCLI = Start("dotnet", $"serve -d:\"{wwwrootDir}\" -p:{this.ListenPort}", projDir);
        }
